...
import de.org.mchahn.baselib.io.MultiplexBlockDevice;
...
public class TCBlockDevice extends BlockDeviceImpl {
    ...
    static final String PROPS_PFX = "tcblockdevice.";
    ...
    protected final Boolean usedBackupHeader;
    ...
    /** @see de.org.mchahn.baselib.io.BlockDeviceImpl#internalRead(long, byte[], int) */
    protected void internalRead(long num, byte[] block, int ofs) throws IOException {
        this.mpbdev.read(num, block, ofs);
    }

    /** @see de.org.mchahn.baselib.io.BlockDeviceImpl#internalWrite(long, byte[], int) */
