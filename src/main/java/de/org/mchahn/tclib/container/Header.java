...
import de.org.mchahn.tclib.crypto.CRC32;
import de.org.mchahn.tclib.crypto.Hash;
import de.org.mchahn.tclib.crypto.PKCS5;
import de.org.mchahn.tclib.crypto.Rand;
import de.org.mchahn.tclib.crypto.Registry;
import de.org.mchahn.tclib.crypto.XTS;
...
public class Header implements Erasable {
    ...
    public static final int SIZE = BLOCK_SIZE * BLOCK_COUNT;
    ...
    public static final int OFS_RESERVED3 = 512;
    /** Offset in the header where the hidden volume header might be located.*/
    public static final int OFS_HIDDEN_VOLUME_HEADER = 65536;
    ...
    public enum Type {
        ...
        public final Version lowestHeader;

        /** The lowest app version we can deal with. */
        public final Version lowestApp;
