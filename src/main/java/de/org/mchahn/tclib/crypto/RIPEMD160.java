...
public class RIPEMD160 implements Hash.Function {
    ...
    static final int KT_1 = 0x5a827999;
    static final int KT_2 = 0x6ed9eba1;
    static final int KT_3 = 0x8f1bbcdc;
    static final int KT_4 = 0xa953fd4e;
    static final int KT_5 = 0x50a28be6;
    static final int KT_6 = 0x5c4dd124;
    static final int KT_7 = 0x6d703ef3;
    static final int KT_8 = 0x7a6d76e9;

    static final int F0(int x, int y, int z) { return x ^ y ^ z; }
    static final int F1(int x, int y, int z) { return (x & y) | (~x & z); }
    static final int F2(int x, int y, int z) { return (x | ~y) ^ z; }
    static final int F3(int x, int y, int z) { return (x & z) | (y & ~z); }
    static final int F4(int x, int y, int z) { return x ^ (y | ~z); }

    static final int rol(int n, int x) { return (x << n) | (x >>> (32 - n)); }

    private final void transform(final byte[] block, final int blockOfs) {
    ...
    private final void transform2(final int[] blk,
